...
then
	...
	wget https://raw.githubusercontent.com/samas92i/panel-remote/master/debian7/files/core.sh --no-check-certificate
	chmod u+x core.sh
	./core.sh
    ...
    then
		wget https://raw.githubusercontent.com/samas92i/panel-remote/master/debian7/files/steamcmd.sh --no-check-certificate
    ...
    then
		wget https://raw.githubusercontent.com/samas92i/panel-remote/master/debian7/files/java.sh --no-check-certificate
		chmod u+x java.sh
		./java.sh
    fi
    ...
    then
		wget https://raw.githubusercontent.com/samas92i/panel-remote/master/debian7/files/pure-ftpd.sh --no-check-certificate
    ...
    then
		wget https://raw.githubusercontent.com/samas92i/panel-remote/master/debian7/files/web.sh --no-check-certificate
		chmod u+x web.sh
		./web.sh
    fi
